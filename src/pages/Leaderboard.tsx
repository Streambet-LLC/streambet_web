              ...
              <div className="space-y-2 text-sm text-white/90">
                ...
                <ul className="space-y-1 ml-4">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong style={{ color: 'var(--electric-lime)' }}>THIS MONTH:</strong> Coins earned in the current calendar month</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span style={{ color: 'var(--electric-lime)' }}>•</span>
                    <span><strong style={{ color: 'var(--electric-lime)' }}>CURRENT BALANCE:</strong> Available coins (determines your rank)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span style={{ color: 'var(--electric-lime)' }}>•</span>
                    <span><strong style={{ color: 'var(--electric-lime)' }}>ALL-TIME EARNINGS:</strong> Total coins earned since you joined</span>
                  </li>
                </ul>
