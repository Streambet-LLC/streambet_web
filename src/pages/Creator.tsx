...
const Admin = () => {
  ...
  if (!isProfileFetching && profile?.role !== 'creator') {
    return <Navigate to="/" replace />;
  }

  return (
    <CreatorLayout onDashboardClick={handleDashboardClick} isStreamContent={isStreamContent}>
      <CreatorManagement
        key={resetKey}
        session={profile}
        streams={streams}
        ...
        nonVideoStreams={nonVideoStreams}
