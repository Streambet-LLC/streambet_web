      ...
      <main className="container flex-1 py-16">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold tracking-tight">CardCade Terms of Service</h1>
            ...
            {[
                ...
                content: (
                  <>
                    <p className="text-muted-foreground mb-4">
                      Welcome to CardCade! These Terms of Service ("Terms") are a legal agreement between you ("you," "Player," or "User") and CardCade Inc. ("CardCade," "we," "us," or "our"). By creating an account or using the CardCade website and apps (collectively, the "Platform"), you accept and agree to be bound by these Terms, our Privacy Policy, and all applicable rules and policies referenced herein. If you do not agree, you must not use the Platform.
                    </p>
                    <p className="text-muted-foreground mb-4">
                      <strong>IMPORTANT:</strong> CardCade is a <strong>100% free-to-play entertainment platform</strong>. There are <strong>no purchases, no payments, and no real-money gambling</strong>. All users receive free tokens to play games and compete for prizes. Tokens have no cash value and cannot be purchased. Prizes consist of merchandise, gift cards, and other non-cash rewards. All gameplay is for entertainment purposes only. <strong>These Terms include a binding arbitration agreement and class action waiver.</strong> Please read carefully to understand your rights.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    ...
                    <p className="text-muted-foreground mb-4">
                      You must be at least 18 years old to register and play on CardCade. By using the Platform, you represent that you are at least 18 years of age.
                    </p>
                    
                    <p className="text-muted-foreground mb-2 font-semibold">1.2 General Availability:</p>
                    <p className="text-muted-foreground mb-4">
                      CardCade is a free-to-play entertainment platform available to users where permitted by law. By accessing the Platform, you represent that your use complies with all applicable local, state, and federal laws in your jurisdiction.
                    </p>
                  </>
              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    <p className="text-muted-foreground mb-4">
                      To use CardCade, you must register an account with a valid email, create a username, and confirm you are 18 years or older. You agree to provide truthful and current information about yourself during registration. Each individual is limited to one (1) account. Creating multiple accounts is strictly prohibited and may result in all accounts being closed.
                    </p>
                    <ul className="list-disc pl-6 space-y-2 mb-4">
                      <li className="text-muted-foreground">Accounts are non-transferable and may not be sold, assigned, or shared. Attempting to sell or transfer an account is a violation of these Terms and will result in account closure.</li>
                    ...
                    <p className="text-muted-foreground mb-4">
                      CardCade reserves the right to verify your identity, age, and residency at any time. You may be required to submit documentation (e.g. government-issued ID, proof of address such as a utility bill) to confirm you meet the eligibility requirements. Failure to provide requested information or the discovery of false information may result in suspension or termination of your account.
                    </p>

                    <p className="text-muted-foreground mb-2 font-semibold">2.3 Account Security:</p>
                    <p className="text-muted-foreground mb-4">
                      You agree to use the Platform only for personal, non-commercial entertainment. You must not use anyone else's account or allow anyone else to use your account. We are not responsible for any loss or activity that results from your failure to secure your account. CardCade may in its discretion suspend or terminate any account that appears to be compromised or involved in fraudulent or suspicious activity.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-muted-foreground mb-4">
                      CardCade operates on a <strong>100% free-to-play model</strong>. All users receive free tokens to play games on the Platform. Tokens have no cash value and cannot be purchased, sold, or transferred.
                    </p>
                    ...
                    <ul className="list-disc pl-6 space-y-4 mb-4">
                      <li className="text-muted-foreground">
                        <strong>Free Distribution:</strong> All tokens are provided free of charge through daily bonuses, promotional giveaways, account registration bonuses, and special events. There is never any cost to obtain tokens.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>Entertainment Use:</strong> Tokens are used to play games on the Platform. Game outcomes are determined by chance using random number generators or other fair chance-based mechanics.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>No Cash Value:</strong> Tokens have no monetary value and cannot be redeemed for cash. They are virtual credits for entertainment purposes only.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>Non-Transferable:</strong> Tokens cannot be transferred to other users, sold, or converted to anything of value outside the Platform.
                      </li>
                    </ul>

                    <p className="text-muted-foreground mb-2 font-semibold">3.2 Prizes:</p>
                    <p className="text-muted-foreground mb-4">
                      When playing games with tokens, users may win prizes including merchandise, gift cards, and other non-cash rewards. Prize availability and types are determined by CardCade and may change at any time. Prizes have no cash redemption value and cannot be exchanged for cash.
                    </p>

                    <p className="text-muted-foreground mb-2 font-semibold">3.3 Token Balance:</p>
                    <p className="text-muted-foreground mb-4">
                      Your token balance is shown in your account and reflects tokens available for gameplay. Tokens do not expire while your account remains active, but CardCade reserves the right to remove tokens from dormant accounts (accounts with no activity for 12+ months) after attempts to contact you.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-muted-foreground mb-4">
                      Users may win prizes through gameplay on the Platform. All prizes consist of merchandise, gift cards, or other non-cash rewards. CardCade does not offer cash prizes or cash redemptions.
                    </p>

                    <p className="text-muted-foreground mb-2 font-semibold">4.1 Prize Types:</p>
                    <p className="text-muted-foreground mb-4">
                      Prizes may include but are not limited to: gift cards to various retailers, physical merchandise, digital goods, or other items as determined by CardCade. Prize availability and selection are at CardCade's sole discretion and may change at any time.
                    </p>

                    <p className="text-muted-foreground mb-2 font-semibold">4.2 Redemption Process:</p>
                    <p className="text-muted-foreground mb-4">
                      To redeem a prize, users must initiate a redemption request through the Platform. CardCade will provide instructions for prize delivery, which may include shipping physical items or delivering digital codes via email. Processing times vary depending on prize type and availability.
                    </p>

                    <p className="text-muted-foreground mb-2 font-semibold">4.3 Eligibility:</p>
                    <p className="text-muted-foreground mb-4">
                      Prize redemption is subject to account verification to confirm eligibility. CardCade reserves the right to request additional information to prevent fraud or abuse. Prizes are void where prohibited by law.
                    </p>

                    <p className="text-muted-foreground mb-2 font-semibold">4.4 No Cash Value:</p>
                    <p className="text-muted-foreground mb-4">
                      Prizes have no cash redemption value and cannot be exchanged for cash, transferred to other users, or substituted except at CardCade's sole discretion. In some cases, CardCade may substitute a prize of equal or greater value if the advertised prize becomes unavailable.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-muted-foreground mb-4">
                      When using the Platform, you agree to abide by the following rules of conduct and gameplay:
                    </p>
                    ...
                    <ul className="list-disc pl-6 space-y-4 mb-4">
                      ...
                      <li className="text-muted-foreground">
                        <strong>Platform Abuse:</strong> Attempting to abuse, manipulate, or exploit the Platform's systems or promotional programs in ways not intended by CardCade.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>Fraud and Illegal Use:</strong> Using the Platform for any fraudulent or unlawful purpose. This includes attempting to fraudulently obtain tokens or prizes. Any suspected illegal activity will be reported to authorities.
                      </li>
                      <li className="text-muted-foreground">
                    ...
                    <p className="text-muted-foreground mb-4">
                      CardCade is intended for casual entertainment. Although no real money is at risk in the games, we encourage users to play responsibly and within reasonable time limits. If you believe you have a compulsive behavior toward gaming, please use our self-exclusion or cooling-off tools available (see Section 9 on Responsible Social Gaming) or seek help from organizations such as Gaming Addicts Anonymous. You may self-exclude by contacting customer support, in which case we will disable your account for a chosen period or permanently as requested.
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    ...
                    <p className="text-muted-foreground mb-4">If an account is closed or terminated by us due to violation of Terms, any tokens in the account will be forfeited and any unredeemed prizes may also be forfeited. We will not typically confiscate legitimate prizes without cause; however, any fraudulent gains or winnings from prohibited conduct are void. For example, if you obtained tokens or prizes by cheating, those prizes will not be paid, and any related transactions may be reversed.</p>
                    <p className="text-muted-foreground mb-2 font-semibold">7.3 User-Initiated Closure:</p>
                    <p className="text-muted-foreground mb-4">You may choose to close your account at any time by contacting customer support. We will guide you through the process. If you have an eligible prize balance at that time, we will allow you to redeem it before closure. Any remaining tokens will be forfeited upon closure (since they are promotional credits). Account closure is generally permanent; if you change your mind, you would need to register a new account (and may not be entitled to new sign-up bonuses if you already received them previously).</p>
              ...
              },
              {
                ...
                content: (
                  <>
                    <p className="text-muted-foreground mb-2 font-semibold">8.1 Free Entertainment Platform:</p>
                    <p className="text-muted-foreground mb-4">CardCade is a free-to-play entertainment platform. By using the Platform, you acknowledge that you are playing with promotional tokens that have no monetary value. You are not wagering any real money. All tokens are distributed for free. The Platform's games intend to simulate casino or betting style games for entertainment purposes only. All references to "betting" or "odds" are part of the game theme but do not imply traditional gambling activity or real-money wagering.</p>
                    <p className="text-muted-foreground mb-2 font-semibold">8.2 Entertainment Value Only:</p>
                    <p className="text-muted-foreground mb-4">Tokens have no monetary value and cannot under any circumstances be exchanged for real currency. You cannot sell or trade your tokens. Any purported sale or trade of an account or tokens is void and is a violation of these Terms.</p>
                    <p className="text-muted-foreground mb-2 font-semibold">8.3 Third-Party Content:</p>
                    <p className="text-muted-foreground mb-4">The Platform may display or provide access to content provided by third parties (for example, game software from third-party developers, or promotional offers from partners). CardCade does not guarantee the accuracy or integrity of third-party content. If the Platform contains links to third-party websites or services, these are provided for convenience; we do not endorse or take responsibility for third-party sites. Use caution and review third-party terms and privacy policies when leaving our Platform.</p>
                    <p className="text-muted-foreground mb-2 font-semibold">8.4 Service Availability:</p>
                    <p className="text-muted-foreground mb-4">We strive to keep the Platform available 24/7, but we do not guarantee uninterrupted service. Maintenance, upgrades, or network and power outages may cause temporary service interruptions. We are not liable for any loss of potential prizes or user inconvenience due to downtime. However, if a disruption causes a specific game round or promotion to fail in a way that affects you (e.g., a game crashes as you win), contact support – we will investigate and, if appropriate, restore the state (such as re-crediting tokens for an aborted round).</p>
                    <p className="text-muted-foreground mb-2 font-semibold">8.5 Changes to the Service:</p>
                    <p className="text-muted-foreground mb-4">CardCade reserves the right to modify, add, or remove features and games on the Platform. We may introduce new games or retire existing ones. We may adjust token distribution programs, bonus programs, payout options, or any other aspect of the service. We will endeavor to give notice of material changes (via the app, website, or email), but we are not obligated to maintain any specific aspect of the Platform for any minimum time, except as required by law. If you continue to use the Platform after changes, you are deemed to accept those changes. If you object to a change, your remedy is to stop using the service or close your account.</p>
                    <p className="text-muted-foreground mb-2 font-semibold">8.6 Intellectual Property:</p>
                    <p className="text-muted-foreground mb-4">All content on CardCade (including but not limited to game graphics, text, software code, logos, trademarks, and audiovisual elements) is owned by or licensed to CardCade and is protected by intellectual property laws. We grant you a limited, revocable, non-transferable license to use the Platform and its content for the sole purpose of participating in the games and services as allowed by these Terms. You may not copy, modify, distribute, perform, display, or create derivative works from our content except as expressly permitted. “CardCade,” our logos, and our game titles are trademarks of CardCade, Inc. You agree not to infringe our IP rights. Any feedback or suggestions you provide to CardCade can be used by us freely and without compensation to you.</p>
              ...
              },
              {
                ...
                content: (
                  <>
                    <p className="text-muted-foreground mb-4">Your privacy is important to us. Our collection, use, and protection of your personal information are governed by our <b>Privacy Policy</b> (available on our website). By using CardCade, you consent to the practices described in the Privacy Policy. Key points include:</p>
                    <ul className="list-disc pl-6 space-y-2 mb-4">
                      ...
                      <li>If CardCade’s business is ever transferred or sold, user information may be transferred as part of that transaction (we will ensure any successor honors similar privacy commitments).</li>
                    </ul>
              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    <p className="text-muted-foreground mb-4"><b>Subject to the arbitration agreement above</b>, if any dispute arising out of these Terms is found not subject to arbitration (for example, if you opt out of arbitration or a claim is allowed to proceed in court), then you and CardCade agree that <b>such claim will be brought exclusively in the state or federal courts located in the State of Delaware</b>. You and CardCade <b>consent to the personal jurisdiction of Delaware courts</b> for litigation of allowed disputes, and waive any objections to such venue on grounds of inconvenience or jurisdiction. This provision is subject to any rights you may have under applicable consumer protection laws regarding venue; but to the extent permitted, you agree Delaware is an appropriate and convenient forum.</p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    ...
                    <ul className="list-disc pl-6 space-y-2 mb-4">
                      <li><b>CardCade, Inc.</b> (Attn: Legal/Support)</li>
                      <li>[Address]</li>
