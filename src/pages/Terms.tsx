            ...
            {[
              {
                ...
                content: (
                  <>
                    ...
                    <p className="text-muted-foreground mb-4">
                      <strong>IMPORTANT:</strong> This Platform <strong>does not offer real-money gambling</strong>. <strong>No purchase is necessary</strong> to play or participate, and making purchases will <strong>not increase your chances of winning</strong>. All gameplay is for entertainment purposes only. Prizes can be won in <strong>Stream Coin Mode</strong> (sweepstakes play), but <strong>Pro Coins have no monetary value</strong> until redeemed in compliance with these Terms. <strong>These Terms include a binding arbitration agreement and class action waiver.</strong> Please read carefully to understand your rights.
                    </p>
                  </>
                ),
              },
              ...
              {
                title: "3. Dual-Currency System: Gold Coins and Pro Coins",
                content: (
                  <>
                    <p className="text-muted-foreground mb-4">
                      Streambet operates a <strong>dual-currency model</strong> consisting of <strong>Gold Coins</strong> and <strong>Pro Coins</strong>. These virtual currencies are central to how the Platform offers both free-to-play entertainment and sweepstakes promotions. It is critical that you understand the differences between them:
                    </p>
                    
                    <ul className="list-disc pl-6 space-y-4 mb-4">
                      <li className="text-muted-foreground">
                        <strong>Gold Coins (GC):</strong> Gold Coins are <strong>play-for-fun virtual credits</strong>. They are designed for entertainment-only gameplay and <strong>have no cash value</strong>. Gold Coins <strong>cannot be redeemed for real money or any prize</strong> – they are used just like points to play games for amusement. You can acquire Gold Coins in various ways (purchases or free bonuses), and use them to play the casino-style games on the Platform in "Gold Coin Mode." All outcomes in Gold Coin Mode are for entertainment (e.g., showing what you <em>could</em> have won) but yield no prize. <strong>Gold Coins are not transferable</strong> to other users and cannot be converted into Pro Coins.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>Pro Coins (SC):</strong> Pro Coins are <strong>sweepstakes entries</strong> in the form of virtual coins. Pro Coins <strong>can be redeemed for real prizes</strong> (such as cash or gift cards) in accordance with our redemption procedures. Importantly, Pro Coins <strong>are never for sale</strong> – you <strong>cannot and will not purchase Pro Coins directly</strong>. Instead, Pro Coins are <strong>obtained free of charge</strong> via various methods (detailed in Section 5). Using Pro Coins to play games on the Platform in "Stream Coin Mode" gives you a chance to win prizes from those games. Stream Coin gameplay is part of Streambet's sweepstakes system. While Stream Coin game outcomes look identical to Gold Coin game outcomes, the difference is that wins in Stream Coin Mode translate to prize winnings that can be redeemed. <strong>No purchase is necessary</strong> to obtain or use Pro Coins in the sweepstakes, and purchases of Gold Coins <strong>do not increase your odds of winning</strong> with Pro Coins.
                      </li>
                    </ul>

                    <p className="text-muted-foreground mb-4">
                      <strong>IMPORTANT:</strong> Gold Coins have <strong>no monetary value and cannot be redeemed</strong>, whereas Pro Coins are <strong>promotional sweepstakes entries</strong> that are <strong>potentially redeemable for prizes</strong> but <strong>only obtained without purchase</strong>. You <strong>cannot convert Gold Coins to Pro Coins</strong> (or vice versa), and <strong>neither virtual coin is "real money" or cryptocurrency.</strong> They are simply digital tokens for different play modes (one for fun, one for prize play).
                    </p>
                  </>
                ),
              },
                ...
                content: (
                  <>
                    ...
                    <ul className="list-disc pl-6 space-y-4 mb-4">
                      ...
                      <li className="text-muted-foreground">
                        <strong>No Prizes in Gold Coin Mode:</strong> Playing with Gold Coins <strong>will not yield any prizes or rewards</strong> beyond in-game enjoyment. You <strong>cannot win real money</strong> or Pro Coins when using Gold Coins. Wins or losses of Gold Coins are purely virtual. Gold Coins cannot be traded, transferred, or converted to anything of value.
                      </li>
                      <li className="text-muted-foreground">
                    ...
                    <p className="text-muted-foreground mb-4">
                      From time to time, Streambet may offer bonus Pro Coins with Gold Coin package purchases. For example, if you buy a special Gold Coin pack, you might receive a certain number of Pro Coins for free as a promotion. Any such bonus Pro Coins are provided <em>gratis</em> to enable sweepstakes play and do not represent a sale of Pro Coins. The number of Pro Coins (if any) given as a bonus will be clearly displayed at the time of purchase. All Gold Coin purchases (with or without bonus Pro Coins) remain final and non-refundable. Bonus Pro Coins are subject to the rules in Section 5 (they are sweepstakes entries).
                    </p>
                  </>
                ),
              },
              {
                ...
                content: (
                  <>
                    <p className="text-muted-foreground mb-4">
                      Stream Coin Mode allows you to participate in our sweepstakes system for a chance to win real prizes. <strong>Playing in Stream Coin Mode is always free — you can only use Pro Coins that have been obtained through free methods.</strong> Key points about Pro Coins and sweepstakes:
                    </p>

                    <p className="text-muted-foreground mb-2 font-semibold">5.1 How to Obtain Pro Coins (No Purchase Necessary):</p>
                    <p className="text-muted-foreground mb-4">
                      You cannot buy Pro Coins from Streambet, and no payment is required to get Pro Coins. Every user has multiple free avenues to obtain Pro Coins, including:
                    </p>

                    <ul className="list-disc pl-6 space-y-4 mb-4">
                      <li className="text-muted-foreground">
                        <strong>Free Bonus with Gold Coin Purchase:</strong> As noted, when you purchase certain Gold Coin packages, we may grant complementary Pro Coins as a <strong>free bonus</strong> (e.g., "Bonus 10 Pro Coins" with a Gold Coin pack). This <strong>does not constitute a purchase of Pro Coins</strong>; the Pro Coins are provided for free as part of a promotion.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>Alternate Means of Entry (AMOE):</strong> Streambet offers a <strong>mail-in or online request option</strong> for free Pro Coins. For example, you may mail a request (a 3x5 postcard with your name, address, email, etc.) to our designated address to receive a certain number of Pro Coins for free, without any purchase. See the official <strong>Streambet Sweepstakes Rules</strong> for the detailed AMOE instructions (address, frequency of requests allowed, etc.). All valid requests will be honored as outlined, and any postage or minor costs incurred are not payment for Pro Coins but incidental costs. AMOE ensures that <strong>everyone has an equal chance to participate without purchase</strong>, in compliance with sweepstakes law.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>Promotions and Giveaways:</strong> We may distribute Pro Coins via special promotions, such as sign-up bonuses, referral bonuses, social media contests, tournament rewards, or daily login rewards. These are <strong>free promotional offers</strong>. For instance, upon registration you might get some Pro Coins to start, or you might earn Pro Coins by completing certain tasks (like verifying your account or reaching a gameplay milestone) – all without any purchase.
                      </li>
                      <li className="text-muted-foreground">
                        <strong>No "Pay-to-Play":</strong> Regardless of method, any Pro Coins you receive are free of charge. While you might acquire them alongside a Gold Coin purchase or as part of using the service, there is <strong>never a requirement to pay for Pro Coins</strong>. Purchasing Gold Coins is optional and for entertainment; you would receive the same opportunity to play in Stream Coin Mode whether or not you make purchases (Streambet's sweepstakes have <strong>no purchase necessary</strong>).
                      </li>
                    </ul>

                    <p className="text-muted-foreground mb-2 font-semibold">5.2 Using Pro Coins to Play (Sweepstakes Entries):</p>
                    <p className="text-muted-foreground mb-4">
                      When you use your Pro Coins on the Platform (by entering a sweepstakes game round in Stream Coin Mode), you are participating in a sweepstakes promotion. Each wager of Pro Coins on a game constitutes an entry into the sweepstakes associated with that game round. The game will spin or play out, and if you "win" in the game, you win a prize (as detailed below). If you lose, the Pro Coins you used are simply removed from your balance (just as used entries in any sweepstakes are exhausted). The outcome of the game is determined by chance, using random number generators or other fair chance-based mechanics.
                    </p>
                    <p className="text-muted-foreground mb-4">
                    ...
                    <p className="text-muted-foreground mb-4">
                      When you win playing with Pro Coins, you win a prize. Prizes are typically denominated in U.S. Dollars (cash value) or sometimes in a specified item (e.g., gift card, merchandise, etc., at our discretion). The default prize for Stream Coin wins is a cash prize that can be redeemed for USD at a rate of $1 per 1 Stream Coin won, unless otherwise stated in a particular promotion. The specifics of prize values and redemption rates will be communicated in the game or promotion details. Key rules for prize redemption:
                    </p>
                ...
                content: (
                  <>
                    ...
                    <ul className="list-disc pl-6 space-y-4 mb-4">
                      ...
                      <li className="text-muted-foreground">
                        <strong>Fraud and Illegal Use:</strong> Using the Platform for any fraudulent or unlawful purpose. This includes money laundering, using stolen payment methods to purchase Gold Coins, or attempting to cash out fraudulently obtained Pro Coins. All transactions are monitored to prevent fraud and money laundering. Any suspected illegal activity will be reported to authorities.
                      </li>
                      <li className="text-muted-foreground">
              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    <p className="text-muted-foreground mb-4">We strive to keep the Platform available 24/7, but we do not guarantee uninterrupted service. Maintenance, upgrades, or network and power outages may cause temporary service interruptions. We are not liable for any loss of potential prizes or user inconvenience due to downtime. However, if a disruption causes a specific game round or promotion to fail in a way that affects you (e.g., a game crashes as you win), contact support – we will investigate and, if appropriate, restore the state (such as re-crediting Pro Coins for an aborted round).</p>
