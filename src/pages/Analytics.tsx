      ...
      <main className="h-[calc(100dvh-64px)] overflow-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1 max-w-2xl">
            AI-powered card-market intelligence — a research analyst, live
            market data, tracked-card pricing and forecasts.
          </p>
        </div>
            ...
            <Card className="bg-[rgba(22,22,22,1)] border-white/5 p-6 sm:p-8">
              <div className="mx-auto max-w-md text-center">
                ...
                <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-white/60">
                  Seller & buyer discovery, matching, and lead management are on
