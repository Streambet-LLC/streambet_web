          ...
          <DialogFooter>
            <DialogClose asChild>
              <button
                ...
                className="bg-[#272727] text-white font-medium px-3 rounded-lg border-none text-sm flex items-center justify-center hover:bg-[#232323] focus:bg-[#232323] active:bg-[#1a1a1a] transition-colors h-10"
              >
                Cancel
              </button>
            </DialogClose>
            <button
              onClick={handleSave}
              className="bg-primary text-black font-medium px-3 rounded-lg border-none text-sm flex items-center justify-center hover:bg-[#6be612] focus:bg-[#6be612] active:bg-[#5cb90f] transition-colors h-10"
            >
              Save
            </button>
          </DialogFooter>
