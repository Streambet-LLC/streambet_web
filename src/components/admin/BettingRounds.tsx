                          ...
                          (round.options.length > 0 ? (
                            round.options.map((option, optionIndex) => {
                              ...
                              const isDuplicateOption = validationErrors?.some(
                                error =>
                                  ...
                                  round.options.filter(
                                    opt => opt.option.toLowerCase().trim() === optionNameLower
                                  ).length > 1
                              );
                              ...
                              return (
                                ...
                                >
                                  <TableCell
                                    className={`border-t border-b border-[#191D24] px-4 py-2 w-full${isDuplicateOption ? ' border-destructive' : ''}`}
                                    style={{
                                      borderRadius: 0,
                                      maxWidth: 'calc(100% - 56px)',
                                      borderTopWidth: 1,
                                      borderBottomWidth: 1,
                                      borderColor: isDuplicateOption ? '#ef4444' : '#191D24',
                                    }}
                                  >
                                    <div
                                    ...
                                    >
                                      <div
                                        className={`flex items-center w-full${isDuplicateOption ? ' border-destructive' : ''}`}
                                        style={{
                                          height: 44,
                                          background: '#272727',
                                          borderRadius: 8,
                                          paddingLeft: 16,
                                          paddingRight: 16,
                                          border: isDuplicateOption ? '1px solid #ef4444' : 'none',
                                        }}
                                      >
                                        <InlineEditable
                                          ...
                                          style={{
                                            color: isDuplicateOption ? '#ef4444' : '#FFFFFFBF',
                                            maxWidth: '100%',
                                          }}
                                          minLength={2}
                                        />
                                  ...
                                  <TableCell
                                    className={`border-t border-b border-[#191D24] p-0 w-14${isDuplicateOption ? ' border-destructive' : ''}`}
                                    style={{
                                      borderRadius: 0,
                                      width: 56,
                                      borderTopWidth: 1,
