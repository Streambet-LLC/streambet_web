...
export const WalletBalance = ({ balance = 0 }: WalletBalanceProps) => {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-3">
        {!showStreamCoins ? (
          <span className="text-xl font-bold text-yellow-500">{balance.toFixed(0)} Free Coins</span>
        ) : (
          <div className="flex items-center">
            <span className="text-xl font-bold text-green-500">0 Stream Coins</span>
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="max-w-[250px]">
                  <p>
                    Stream Coins will be used for cash betting and is not a part of the private beta
                    yet.
                  </p>
                </TooltipContent>
              </Tooltip>
